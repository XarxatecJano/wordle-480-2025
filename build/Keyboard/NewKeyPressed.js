...
var NewKeyPressed = /** @class */ (function (_super) {
    __extends(NewKeyPressed, _super);
    function NewKeyPressed(pickedWord) {
    ...
    NewKeyPressed.prototype.newKeyPressed = function (code) {
        var letter = ValidateLetter.getInstance(code, this.actualPosition);
