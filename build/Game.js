...
var Game = /** @class */ (function () {
    ...
    Game.prototype.iniciarJuego = function () {
    ...
    Game.prototype.newKeyPressed = function (code) {
        if (this._actualWord.letras.length < MAX_WORD_SIZE) {
            if (this._teclado.isValidLetter(code)) {
                var letter = new Letra(this._teclado.transformCodeToLetter(code));
        ...
        if (this._teclado.isEnterKey(code))
            this.enterPressed();
        if (this._teclado.isBackspaceKey(code))
            this.backspacePressed();
        if (this._turno.getPosition() <= MAX_WORD_SIZE)
