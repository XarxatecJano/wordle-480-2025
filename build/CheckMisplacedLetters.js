...
var CheckMisplacedLetters = /** @class */ (function () {
    ...
    CheckMisplacedLetters.prototype.changeColorDependingOnCoincidences = function (actualPosition, actualLetter, game) {
        ...
        if (((_a = game.rightPositionLetters.get(actualLetter)) !== null && _a !== void 0 ? _a : 0) < numberOfCoincidences && ((_b = game.misplacedPositionLetters.get(actualLetter)) !== null && _b !== void 0 ? _b : 0) < numberOfCoincidences) {
